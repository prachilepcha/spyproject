...
status_message = ["Winter is comming", "Busy", "DND"]
...
def add_status():
    ...
    if spy.current_status_message != None:
        ...
        print "No status message currently \n"
    ...
    if default.upper() == "N":
        ...
        print "Invalid option! Press either Y or N."

    if updated_status_message:
        print "Your updated status message is: %s" % (updated_status_message)
    else:
        print "No current status update."
...
def add_friend():
    ...
    new_friend.name = raw_input("Add friend's name:")
    ...
    if len(new_friend.name) > 0 and new_friend.age > 12 and new_friend.rating >= spy.rating:
        ...
        print "Friend Added!"
        print "You and %s are now friends." % (new_friend.name)
    else:
        print "Invalid entry. We can't add this spy."
